...
Da es im Detailhandel neben Regulären Mitarbeitern auch viele andere temporäre Arbeitskräfte gibt, verzichten wir hier auf eine konkretere Einteilung und empfehlen die Anzahl Mitarbeiter der Tabelle entsprechend anzupassen.

Da sich viele kleinere Bestellungen im Datensatz finden, erachten wir es auch eine gute Möglichkeit den Bezahlvorgang an den Kassen durch self-pay möglichkeiten zu ergänzen. Dadurch sollte sich einerseits ein möglicher Anstieg der Auslastung, durch die Verschiebung der Bestellungen aus den nicht abgedeckten Zeiten, kompensieren lassen und je nach dem sogar Kassenpersonal für andere Arbeiten freigeben, ohne, dass mehr Mitarbeiter als uhrsprünglich in den neuen Öffnungszeiten vorhanden sind.
