...
```{r}
aisle <- dbGetQuery(con,  "SELECT * From aisle LIMIT 30000")
department <- dbGetQuery(con,  "SELECT * From department LIMIT 30000")
orders <- dbGetQuery(con,  "SELECT * From orders LIMIT 30000")
orders_product_prior <- dbGetQuery(con,  "SELECT * From orders_product_prior LIMIT 30000")
orders_product_train <- dbGetQuery(con,  "SELECT * From orders_product_train LIMIT 30000")
product <- dbGetQuery(con,  "SELECT * From product LIMIT 30000")
```
...
```{r}
items_per_order <- orders_product_prior %>% 
  group_by(orders_id) %>%
