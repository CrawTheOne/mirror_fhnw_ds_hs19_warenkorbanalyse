...
Die Auslastung beträgt pro Stunde durchschnittlich `r round(avg_workload_25, digits = 1)` Prozent.
...
Die Auslastung beträgt pro Stunde durchschnittlich `r round(avg_workload_35, digits = 1)` Prozent.
...
Die Auslastung beträgt pro Stunde durchschnittlich `r round(avg_workload_50, digits = 1)` Prozent.
...
Die Auslastung beträgt pro Stunde durchschnittlich `r round(avg_workload_60, digits = 1)` Prozent.
